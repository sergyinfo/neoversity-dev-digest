...
Agreed requirements / acceptance criteria for the `reviewer-core` package, one folder per module,
...
`.claude/agents/spec-creator.md`. Numbers are never reused or renumbered. Empty for now.
